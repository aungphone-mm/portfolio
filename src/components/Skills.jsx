...
const skillCategories = [
  {
    ...
    color: '#7c3aed',
    skills: [
      { name: 'Odoo ERP Development', level: 95 },
      { name: 'Python', level: 90 },
      { name: 'PostgreSQL / SQL Server', level: 88 },
      { name: 'QWeb / PDF Reports', level: 85 },
    ],
  },
  {
    categoryKey: 'backend',
  ...
  },
  {
    ...
    color: '#f59e0b',
    skills: [
      { name: 'Claude Code / MCP', level: 85 },
      { name: 'VS Code / Cursor', level: 90 },
      { name: 'C# / .NET', level: 65 },
      { name: 'Azure (foundational)', level: 60 },
    ],
  },
];
